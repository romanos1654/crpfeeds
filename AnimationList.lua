...
DP.Emotes = {
    ...
    --TAC LSPDFR
    ["tacrifle1"] = { "anim@male@holding_weapon_2", "holding_weapon_2_clip", "TacPose", AnimationOptions = { EmoteLoop = true, EmoteMoving = true } },
    ["tacrifle2"] = { "anim@male@holding_weapon_4", "holding_weapon_4_clip", "TacPose", AnimationOptions = { EmoteLoop = true, EmoteMoving = true } },
    ["tacrifle3"] = { "anim@male@holding_weapon_kneel", "anim@male@holding_weapon_kneel_clip", "TacPose", AnimationOptions = { EmoteLoop = true, EmoteMoving = true } },
    ["tacrifle4"] = { "anim@male@holding_weapon_nvg", "holding_weapon_nvg_clip", "TacPose", AnimationOptions = { EmoteLoop = true, EmoteMoving = true } },
    ["tacrifle5"] = { "anim@male@holding_weapon_nvg_2", "holding_weapon_nvg_2_clip", "TacPose", AnimationOptions = { EmoteLoop = true, EmoteMoving = true } },
    ["hugweapon1"] = { "anim@male@hug_weapon", "hug_weapon_clip", "TacPose", AnimationOptions = { EmoteLoop = true, EmoteMoving = true } },
    ["hugweapon2"] = { "anim@male@hug_weapon_2", "hug_weapon_2_clip", "TacPose", AnimationOptions = { EmoteLoop = true, EmoteMoving = true } },
    ["poseweapon1"] = { "anim@male@pose_weapon", "pose_weapon_clip", "TacPose", AnimationOptions = { EmoteLoop = true, EmoteMoving = true } },
    ["poseweapon2"] = { "anim@male@pose_weapon_2", "pose_weapon_2_clip", "TacPose", AnimationOptions = { EmoteLoop = true, EmoteMoving = true } },
    ["poseweapon3"] = { "anim@male@pose_weapon_3", "pose_weapon_3_clip", "TacPose", AnimationOptions = { EmoteLoop = true, EmoteMoving = true } },
    ["aimweapon"] = { "anim@male@aim_weapon", "aim_weapon_clip", "TacPose", AnimationOptions = { EmoteLoop = true, EmoteMoving = true } },
    ["preaimweapon"] = { "anim@male@preaim_weapon", "preaim_weapon_clip", "TacPose", AnimationOptions = { EmoteLoop = true, EmoteMoving = true } },
    ["runweapon"] = { "anim@male@run_weapon", "run_weapon_clip", "TacPose", AnimationOptions = { EmoteLoop = true, EmoteMoving = true } },
    ["tacticalkneel"] = { "anim@male@tactical_kneel", "tactical_kneel_clip", "TacPose", AnimationOptions = { EmoteLoop = true, EmoteMoving = true } },
    ["holdingvest1"] = { "anim@male@holding_vest", "holding_vest_clip", "TacPose", AnimationOptions = { EmoteLoop = true, EmoteMoving = true } },
    ["holdingsidevest"] = { "anim@holding_side_vest", "holding_side_vest_clip", "TacPose", AnimationOptions = { EmoteLoop = true, EmoteMoving = true } },
    ["holdingsiegevest"] = { "anim@holding_siege_vest_side", "holding_siege_vest_side_clip", "TacPose", AnimationOptions = { EmoteLoop = true, EmoteMoving = true } },
    ["holdingvest2"] = { "anim@male@holding_vest_2", "holding_vest_2_clip", "TacPose", AnimationOptions = { EmoteLoop = true, EmoteMoving = true } },
    ["holdingvestsiege1"] = { "anim@male@holding_vest_siege", "holding_vest_siege_clip", "TacPose", AnimationOptions = { EmoteLoop = true, EmoteMoving = true } },
    ["holdingvestsiege2"] = { "anim@male@holding_vest_siege_2", "holding_vest_siege_2_clip", "TacPose", AnimationOptions = { EmoteLoop = true, EmoteMoving = true } },
    ["radioleft"] = { "anim@radio_left", "radio_left_clip", "TacPose", AnimationOptions = { EmoteLoop = true, EmoteMoving = true } },
    ["holdingradio"] = { "anim@male@holding_radio", "holding_radio_clip", "TacPose", AnimationOptions = { EmoteLoop = true, EmoteMoving = true } },
    --
    ["crossarms"] = {
...
DP.White3ro = {
    ...
    ["sport"] = {"perlenfuchs@sport_2", "sport_2_clip", "Sport", AnimationOptions =
    {
       ...
       ["easter1"] = {"missfbi4prepp1", "idle", "Easter basket", AnimationOptions =
       {
          Prop = "bzzz_event_easter_basket_a",
          PropBone = 57005,
          PropPlacement = {0.26, -0.14, -0.16, -60.0, -50.0, 0.0},
          EmoteLoop = true,
          EmoteMoving = true,
       }},
    ...
    ["ccriflekneeladv"] = {
        "anim@rifle_kneel_adv",
        "rifle_kneel_adv_clip",
        "CC | Rifle Kneel Adv",
        AnimationOptions = {
            EmoteLoop = true,
            EmoteMoving = false,
    ...
    ["ccriflekneeladvholding"] = {
        "anim@rifle_kneel_adv_holding",
        "rifle_kneel_adv_holding_clip",
        "CC | Rifle Kneel Adv Holding",
        AnimationOptions = {
            EmoteLoop = true,
            EmoteMoving = false,
        }
    },
    ["smosriflerelax"] = {"anim@fog_rifle_relaxed", "rifle_relaxed_clip", "SMOS | Relaxed With Rifle", AnimationOptions =
    {
        EmoteLoop = true,
        EmoteMoving = false,
    }},
    
    ["smosstack1"] = {"anim@stack_pointman", "pointman_clip", "SMOS | Stack Formation Pointman", AnimationOptions =
    {
        EmoteLoop = true,
        EmoteMoving = false,
    }},
    
    ["smosstack2"] = {"anim@stack_two_man", "two_man_clip", "SMOS | Stack Formation 2nd Man", AnimationOptions =
    {
        EmoteLoop = true,
        EmoteMoving = false,
    }},
    
    ["smosstack3"] = {"anim@stack_three_man", "three_man_clip", "SMOS | Stack Formation Door", AnimationOptions =
    {
        EmoteLoop = true,
        EmoteMoving = false,
    }},
    
    ["smoshighlow1"] = {"anim@highlow_low_lean", "low_lean_clip", "SMOS | High-Low Low Stance", AnimationOptions =
    {
        EmoteLoop = true,
        EmoteMoving = false,
    }},
    
    ["smoshighlow2"] = {"anim@highlow_high_lean", "high_lean_clip", "SMOS | High-Low High Stance", AnimationOptions =
    {
        EmoteLoop = true,
        EmoteMoving = false,
    }},
    ["smoshighlow3"] = {"anim@tactical_highlow_high_leftlean", "high_leftlean_clip", "SMOS | Highlow Left Lean High", AnimationOptions =
    {
        EmoteLoop = false,
        EmoteMoving = false,
    }},
    
    ["smoshighlow4"] = {"anim@tactical_highlow_low_leftlean", "low_leftlean_clip", "SMOS | Highlow Left Lean Low", AnimationOptions =
    {
        EmoteLoop = true,
        EmoteMoving = false,
    }},
    
    ["smoskneeltalkie"] = {"anim@tactical_kneel_walkie", "kneel_walkie_clip", "SMOS | Communication Relaxed Rifle", AnimationOptions =
    {
        EmoteLoop = false,
        EmoteMoving = false,
    }},
    
    ["smosaimkneel"] = {"anim@tactical_kneel_aiming", "kneel_aiming_clip", "SMOS | Kneeling and Aiming Rifle", AnimationOptions =
    {
        EmoteLoop = true,
        EmoteMoving = false,
    }},
    
    ["smosriflerelax1"] = {"anim@male_tactical_collapsed_lowready", "collapsed_lowready_clip", "SMOS | Collapsed Lowready Relaxed Rifle", AnimationOptions =
    {
        EmoteLoop = false,
        EmoteMoving = false,
    }},
    
    ["smosriflerelax2"] = {"anim@male_tactical_highready_relaxed", "highready_relaxed_clip", "SMOS | Highready Relaxed Rifle", AnimationOptions =
    {
        EmoteLoop = true,
        EmoteMoving = false,
    }},
    ["ccholdvest"] = {"anim@male@holding_vest", "holding_vest_clip", "CC | Hold Vest Top", AnimationOptions =
    {
        EmoteLoop = true,
        EmoteMoving = true,
    }},
    ["ccvest2"] = {"anim@holding_side_vest", "holding_side_vest_clip", "CC | Hold Vest Side", AnimationOptions =
    {
        EmoteLoop = true,
        EmoteMoving = true,
    }},
